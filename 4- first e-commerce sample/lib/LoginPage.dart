...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    User u1 = User(name: "omar", email: "email1@gmail.com", password: "1234", SavedProducts: []);
    User u2 = User(name: "mohammed", email: "email2@gmail.com", password: "1234", SavedProducts: []);
    User u3 = User(name: "ali", email: "email3@gmail.com", password: "1234", SavedProducts: []);
